...
const AiThinkingIndicator = () => {
  return (
    <div className="flex w-full justify-start py-2">
      <div className="flex max-w-[85%] flex-col rounded-2xl rounded-bl-sm border border-blue-500/20 bg-[#111116] p-4 shadow-xl shadow-black/40">
        {/* Header with pulsing spark */}
        <div className="flex items-center gap-2.5 mb-3">
          <div className="relative flex h-6 w-6 items-center justify-center rounded-lg bg-blue-600/20 text-blue-400">
            <span className="absolute -inset-0.5 rounded-lg bg-blue-500/30 blur-sm animate-pulse" />
        ...
        <div className="mt-3 flex items-center gap-2 text-[10px] text-neutral-500 font-mono">
          <i className="ri-cpu-line text-blue-400"></i>
